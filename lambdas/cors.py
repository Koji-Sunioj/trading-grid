...
react_cfn_outputs = boto3.client('cloudformation').describe_stacks(
    StackName='merchant-webapp')["Stacks"][0]["Outputs"]
cloudfront_react_url = "https://%s" % search(
    react_cfn_outputs, "OutputKey", "CloudFrontURL")["OutputValue"]
